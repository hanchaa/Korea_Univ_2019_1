...
void display_plan(float plan[2][10]);
void two_month(int current, float usage[3][5]);
void input(float usage[3][5]);
void three_month(int current, float usage[3][5], float plan[2][10]);
void recommend();
...
int main(void) {
	...
	float usage[3][5] = { 0 };
	float plan[2][10] = { {500, 100, 2, 50, 10, 1000, 20000}, {300, 100, 30, 10, 30, 500, 45000} };
